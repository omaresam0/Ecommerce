...
import {addItemToCart, checkout, clearCart, deleteItemInCart, getActiveCart, updateItemInCart} from "../services/cartService.js";
...
router.get("/", validateJWT, async(req: ExtendedRequest, res) => {
        ...
        res.status(200).send(cart);
                ...
                res.status(500).send("Somerthing wen wrong!");
        }
});
